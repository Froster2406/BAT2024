...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\linewidth]{images/BAT_Beispiel_Beschleunigungssensor}
...
% 	https://www.ti.com/lit/an/swca024/swca024.pdf?ts=1709375495514&ref_url=https%253A%252F%252Fwww.google.com%252F
	...
	\subsection{Hardware}
	\subsubsection{PCB}
	Das PCB durchlief mehrere Iterationen. Nachfolgend treten die Änderungen mit den benötigten Zusatzinformationen chronologisch auf. Zudem findet sich eine Übersicht, wieso, welche Bauteile eingesetzt werden.
	\paragraph{V1-1}\mbox{}\\
	...
	\end{itemize}
	\paragraph{V1-3}\mbox{}\\
	Auf Wunsch von hEar wurde zusätzlich noch ein PCB entwickelt, welches funktionsidentisch mit dem Vorgänger ist. Einzig die LEDs sind nun nicht mehr ringförmig angeordnet, sondern erstrecken sich neu auf einer vertikalen Linie. \color{red}TODO\color{black} IN DEN ANHANG BILDER DER DIV. VERSIONEN DES PCB
...
\end{table}
	...
	\begin{itemize}
		\item Das Mikrofon wird konstant im Performance-Modus betrieben. Durch den Einsatz von DMA sind die benötigten Messewerte jeder Zeit verfügbar und die 30ms Start- und Messzeit entfällt. Dadurch sind höher aufgelöste Messintervalle möglich. Siehe Messung  \color{red}TODO\color{black} der einzelnen Module.
