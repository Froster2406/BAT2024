...
\end{table}
	...
	\item[$\bullet$ Verstärkung:]  0 dB
	\item[$\bullet$ Filterordnung:]  5
	\item[$\bullet$ Clock-Dezimierung:]  0
	\end{itemize}
	\subsubsection*{I²C}
	\begin{figure}[H]
		\centering
