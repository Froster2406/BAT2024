	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				color=blue,
				mark=solid,
				] table[col sep=semicolon, x=Frequenz, y=MEMS_Z] {measurements/Microphone/BAT_Frequenzmessung_Geraet.csv};
				\addlegendentry{MEMS}
				\addplot[
				color=red,
				mark=solid,
				] table[col sep=semicolon, x=Frequenz, y=Referenz_Z] {measurements/Microphone/BAT_Frequenzmessung_Referenz.csv};
				\addlegendentry{M2211}
				\fill[green, opacity=0.3] (axis cs:10, 0) -- (axis cs:80, 0) -- (axis cs:80, 120) -- (axis cs:10, 120);
		...
		\end{figure}
		Wie in Abbildung \ref{fig:microphone_plot_ungewichtet} ersichtlich, kann die Messung grob in drei Bereiche eingeteilt werden, wobei jeder Abschnitt eine konkrete Einzelheit aufweist.
		\begin{itemize}
		...
		\centering
			\begin{tikzpicture}
				\begin{axis}[
					...
					color=blue,
					mark=solid,
					] table[col sep=semicolon, x=Frequenz, y=MEMS_A] {measurements/Microphone/BAT_Frequenzmessung_Geraet.csv};
					\addlegendentry{MEMS}
					\addplot[
					color=red,
					mark=solid,
					] table[col sep=semicolon, x=Frequenz, y=Referenz_A] {measurements/Microphone/BAT_Frequenzmessung_Referenz.csv};
					\addlegendentry{M2211}
				\end{axis}
			\end{tikzpicture}
		...
		\end{figure}
		Wie in Abbildung \ref{fig:microphone_plot_gewichtet_A} aufgezeigt, werden die Frequenzen bis ca. 1kHz gedämpft. Dies entspricht der Filtercharakteristik, welche in Abbildung \ref{fig:frequenzbewertung} ersichtlich ist. Somit kann bestätigt werden, dass der implementierte Filter wie gewünscht, funktioniert.
		\begin{figure}[H]
		\centering
			\begin{tikzpicture}
				\begin{axis}[
					...
					color=blue,
					mark=solid,
					] table[col sep=semicolon, x=Frequenz, y=MEMS_C] {measurements/Microphone/BAT_Frequenzmessung_Geraet.csv};
					\addlegendentry{MEMS}
					\addplot[
					color=red,
					mark=solid,
					] table[col sep=semicolon, x=Frequenz, y=Referenz_C] {measurements/Microphone/BAT_Frequenzmessung_Referenz.csv};
					\addlegendentry{M2211}
					\addplot[
					color=red,
					mark=solid,
					] table[col sep=semicolon, x=Frequenz, y=dB2] {measurements/Microphone/BAT_Weighting_Matlab.csv};
