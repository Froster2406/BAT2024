...
\begin{itemize}
	...
	Abbildung \ref{fig:startzeit-mikrofon} zeigt deutlich, dass Mikrofon-Grundrauschen verbessert wird, sofern das Mikrofon jeweils nicht nach jeder Messung in den Energiesparmodus versetzt wird. So konnte ein Rauschboden von bis zu 37dB gemessen werden, welcher demjenigen aus dem Datenblatt (\cite{noauthor_httpsinvensensetdkcomwp-contentuploads202007ds-000157-ics-41351-v14pdf_nodate}) sehr nahe kommt. Bei den Messungen im frei-laufenden Modus variierte der Rauschboden jedoch um jeweils bis zu 10dB.
	\begin{figure}[H]
		\centering
		\begin{tikzpicture}
			\begin{axis}[
	...
	Die drei Messungen zeigen, dass jede untersuchte Fehlerquelle einen Einfluss auf das SNR hat. Insbesondere das Ein- und Auschalten des Mikrofons scheint den hohen Rauschboden zu erklären und muss in einer Folgearbeit überarbeitet werden.
