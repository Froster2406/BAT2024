...
/* set PWM duty cycle for all LED outputs */
...
/* enable all LEDs for a short period of time to check if all of them are working */
...
/* initialize the I2C0 peripheral block */
...
/* deinitialize the I2C0 periperal block */
